...
class GetItSingletonResourceLifecycle<T extends Object> implements ResourceLifecycle<T> {
  final T _resource;
...
class GetItResourceLifecycle<T extends Object> implements ResourceLifecycle<T> {
  final T _resource;
