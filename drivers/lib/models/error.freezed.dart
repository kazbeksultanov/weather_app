...
abstract class $ApiErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? code, String? payload});
}
...
class _$_ApiError implements _ApiError {
  const _$_ApiError({this.code, this.payload});
  ...
  @override
  String toString() {
    return 'ApiError(code: $code, payload: $payload)';
  }
...
abstract class _ApiError implements ApiError {
  const factory _ApiError({final String? code, final String? payload}) =
      _$_ApiError;
