...
class AppFormField<T extends Object> extends StatefulWidget {
...
class _AppFormFieldState<T extends Object> extends State<AppFormField<T>> {
  FormValue<T?>? _value;
  FormsBloc? _bloc;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<FormsBloc, FormsState>(
      ...
      builder: (context, state) {
        debugPrint(
            'builder In field: "${widget.fieldName}" - Received event: "${state.event.runtimeType}" - "${state.event.toString()}"');
        if (state.fieldStates.containsKey(widget.fieldName)) {
          ...
          return widget.builder(
            ...
            AppFormFieldState<T>(
              ...
              value: fieldState.value as FormValue<T>,
              rewrittenValue: fieldState.rewrittenValue != null
                  ? fieldState.rewrittenValue as FormValue<T>
                  : null,
