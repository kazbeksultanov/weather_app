...
class _AppFormTextFieldState extends State<AppFormTextField> {
  ...
  StringFormValue Function() get _initValue => widget.initValue;
  ...
  Widget build(BuildContext context) {
    return AppFormField<String>(
      ...
      builder: (context, state) {
        if (state.event is OnRewriteValue || state.event is OnRewriteFormValues) {
        ...
        return TextField(
          ...
          decoration: widget.decoration.copyWith(
            errorText: state.errorMessage.map((it) => it.localize(context)).orElseNull,
          ),
        );
      },
    );
